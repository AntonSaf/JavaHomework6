...
public class task1 {
   public static void main(String[] args) {
      Notebook notebook1 = new Notebook("Asus", "32", "100", "Windows", "red");
      Notebook notebook2 = new Notebook("Acer", "4", "500", "Linux", "black");
      Notebook notebook3 = new Notebook("MSI", "8", "2000", "Windows", "blue");
      Notebook notebook4 = new Notebook("DELL", "16", "700", "Linux", "grey");
      Notebook notebook5 = new Notebook("Huawei", "8", "1200", "Windows", "green");
